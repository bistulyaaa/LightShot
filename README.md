...
在现代智能手机中，原生相机应用正变得越来越臃肿。复杂的计算摄影算法、繁琐的模式切换以及日益增加的启动延迟，让很多珍贵的瞬间在等待中流逝。**InstantShot 的目标只有一个：在按下图标后的毫秒级时间内，为你捕捉到最真实、最清晰的瞬间。**

相比于 HedgeCam2 等老牌开源相机，InstantShot 走的是一条**现代化且极致精简**的路线。
...
| 特性 | HedgeCam2 / Open Camera | **InstantShot (本项目)** |
| --- | --- | --- |
...
> **开发者寄语**：
> “原生相机给你的也许是‘好照片’，但 InstantShot 给你的是‘拍得到’。”
